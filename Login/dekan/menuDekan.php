    ...
    <body id="page-top" onload="waktu()">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUsulan" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="list_usulan_riset.php">Usulan Proposal</a>
                ...
                <!-- Nav Item - statistik Collapse Menu -->
                <!-- <li class="nav-item">
                    <a class="nav-link collapsed" href="sah_list_Riset.php" aria-expanded="true" aria-controls="collapseTwo">
