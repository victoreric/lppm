...
<div class="container">
<div class="card">
  <div class="card-header font-weight-bold text-center text-primary">Proposal Kerjasama</div>
  <div class="card-body">
    <form method="POST" action="" enctype="multipart/form-data">
        <div class="panel-body">
            <div class="form-group">
                <label for="tahun_pengajuan" class="form-control-label">Tahun Pengajuan:</label>
                <input type="number" class="form-control" id="tahun_pengajuan" name="tahun_pengajuan" value='2024' disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="golongan" class="form-control-label">Pangkat/ Golongan</label>
                <input type="text" class="form-control" id="golongan" value="<?php echo $res_reg['golongan']; ?>" name="golongan" disabled>
            </div>

            <div class="form-group">
                <label for="jafung" class="form-control-label">Jabatan Fungsional</label>
                <input type="text" class="form-control" id="jafung" value="<?php echo $res_reg['jafung']; ?>" name="jafung" disabled>
            </div>
            <div class="form-group">
                <label for="prodi" class="form-control-label">Program Studi</label>
                <input type="text" class="form-control" id="prodi" value="<?php echo $res_reg['prodi']; ?>" name="prodi" disabled>
            </div>
            <div class="form-group">
                <label for="fakultas" class="form-control-label">Fakultas</label>
                <input type="text" class="form-control" id="fakultas" value="<?php echo $res_reg['fakultas_name']; ?>" name="fakultas" disabled>
            </div>
            <div class="form-group">
                <label for="hp" class="form-control-label">Nomor Handphone</label>
                <input type="text" class="form-control" id="hp" value="<?php echo $res_reg['hp']; ?>" name="hp" disabled>
            </div>
            <div class="form-group">
                <label for="email" class="form-control-label">e-Mail</label>
                <input type="text" class="form-control" id="email" value="<?php echo $res_reg['email']; ?>" name="email" disabled>
            </div>
...
if(isset($_POST['simpan'])){
    ...
    // $file_pks=$_FILES['file_pks']['name'];
    // $tmp1=$_FILES['file_pks']['tmp_name'];
    // $unik=$_SESSION['nidn_login'];
    // $file_pks_name = $unik.$file_pks ;
    // $path1='files/kerjasama/'.$file_pks_name;

    // $file_kontrak=$_FILES['file_kontrak']['name'];
    // $tmp2=$_FILES['file_kontrak']['tmp_name'];
    // $unik=$_SESSION['nidn_login'];
    // $file_kontrak_name = $unik.$file_kontrak ;
    // $path2='files/kerjasama/'.$file_kontrak_name;
  
    // if (move_uploaded_file($tmp, $path)) {

        $query = "INSERT INTO kerjasama (tahun_pengajuan, judul, nama_ketua, nip_ketua, nama_pj, nip_pj, golongan_pj, jafung_pj, prodi_pj, fakultas_pj, hp_pj, email_pj, nama_anggota, nip_anggota, golongan_anggota, jafung_anggota, prodi_anggota, fakultas_anggota, hp_anggota, email_anggota, status) VALUES ('$tahun_pengajuan','$judul','$nama_ketua','$nip_ketua','$nama_pj','$nip_pj','$golongan_pj','$jafung_pj','$prodi_pj','$fakultas_pj','$hp_pj','$email_pj','$nama_anggota','$nip_anggota','$golongan_anggota','$jafung_anggota','$prodi_anggota','$fakultas_anggota','$hp_anggota','$email_anggota','')";
